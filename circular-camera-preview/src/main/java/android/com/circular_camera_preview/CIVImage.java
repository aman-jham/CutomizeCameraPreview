...
public class CIVImage extends ImageView {
...
//    private static final ScaleType SCALE_TYPE = ScaleType.FIT_CENTER;
    ...
    public CIVImage(Context context) {
        super(context);

        init();
    }

    public CIVImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CIVImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CIVImage_c_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CIVImage_c_circle_background_color,
